...
if (isset($_POST["create"])){
    ...
    if($a == 0){
            if ($pass == $cpass & strlen($pass)>8 & strpos($email,'@') !== false ){
                ...
                $sql1 ="Insert into userinfo(email_rec,pass,matricule,nom,prenom,email,niveau,date_de_naissance,sexe,date_inscription, etat,admin,code,checkcode)
                values('$email_rec','$pass','$matricule','$nom','$prenom','$email','$niveau',
                '$date','$sexe','$t', '$admin','$code','$check')";
...
<br><br>
    ...
    <img style='display: block;margin-left: auto;margin-right: auto;' src="images/GRH_logo.png" height="90px" width="90px" align="center" class="avatar">
